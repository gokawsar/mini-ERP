...
DROP TABLE IF EXISTS jobs; -- Added for completeness
...
('SP (10% VAT)', 10.00, 'Standard Product VAT 10%'),
('SC (15% VAT)', 15.00, 'Special Category VAT 15%');
...
CREATE TABLE quotation_items (
    ...
    tax_id INT DEFAULT NULL, -- Allow NULL for "None"
    tax_amount DECIMAL(10,2) NOT NULL, -- subtotal * tax_rate/100
